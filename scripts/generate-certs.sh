...
readonly CA_SUBJECT='/CN=LibOps Drupal Local Development CA'
readonly LEAF_SUBJECT='/CN=localhost'
readonly SUBJECT_ALT_NAMES='DNS:*.libops.io,DNS:libops.io,DNS:*.libops.info,DNS:libops.info,DNS:*.drupal.traefik.me,DNS:drupal.traefik.me,DNS:localhost,IP:127.0.0.1,IP:::1'
